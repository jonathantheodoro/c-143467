      ...
      >
        ...
        >
          <span className="text-sm font-medium">
            ...
            Plataforma para construção civil
          </span>
        </motion.div>
        ...
        >
          <div className="glass rounded-xl overflow-hidden">
            <img
              ...
              alt="ObraView Dashboard - Painel do Cliente"
      ...
      <section className="container px-4 py-20 relative bg-black">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Transforme sua empresa com uma plataforma feita para quem constrói. Mostre profissionalismo, organização e confiança em cada entrega.
          </p>
          <Button size="lg" className="button-gradient">
            Criar Conta Grátis
